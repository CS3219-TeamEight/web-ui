...
var ComponentError = (function (_Error) {
  ...
  function ComponentError(message) {
    ...
    _get(Object.getPrototypeOf(ComponentError.prototype), 'constructor', this).call(this, { message: message });
...
var Component = (function (_LayoutManager) {
  ...
  function Component() {
    ...
    _layoutmanager2['default'].prototype.constructor.apply(this, arguments);
...
var _sampleComponentHtml = require('./sample-component.html');

var _sampleComponentHtml2 = _interopRequireDefault(_sampleComponentHtml);

var SampleComponent = _component2['default'].extend({
  template: _sampleComponentHtml2['default'],
...
module.exports = {
_partials: {"partials/nav": require("/Users/hooitong/Work/web-ui/app/views/partials/nav.html")},
_filters: {},
getPartial: function getPartial(name) {
    if (name in this._partials) {
        return this._partials[name];
...
},{"/Users/hooitong/Work/web-ui/app/views/partials/nav.html":8}],6:[function(require,module,exports){
module.exports = {
_partials: {"layouts/page": require("/Users/hooitong/Work/web-ui/app/views/layouts/page.html")},
_filters: {},
getPartial: function getPartial(name) {
    if (name in this._partials) {
        return this._partials[name];
...
},{"/Users/hooitong/Work/web-ui/app/views/layouts/page.html":5}],7:[function(require,module,exports){
'use strict';
