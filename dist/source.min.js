...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_modelsResume=require("../models/resume"),_modelsResume2=_interopRequireDefault(_modelsResume),Resumes=_backbone2["default"].Collection.extend({comparator:function(e,o){var t=e.get("score")-o.get("score");return 0===t?e.get("score")<o.get("score")?-1:1:t},model:_modelsResume2["default"],url:"http://localhost:8080/api/resumes"});exports["default"]=Resumes,module.exports=exports["default"];

},{"../models/resume":5,"backbone":10}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),_dropzone=require("dropzone"),_dropzone2=_interopRequireDefault(_dropzone),_config=function(e){var r={},t=function(e,r){r=r.replace(/\[(\w+)\]/g,".$1"),r=r.replace(/^\./,"");for(var t=r.split("."),i=0,n=t.length;n>i;++i){var u=t[i];if(!(u in e))return;e=e[u]}return e};return r.get=function(r){return t(e,r)},r}({Client:{testProperty:"Default",restServer:{address:"http://188.166.232.209:8080",apiRoot:"/api",resumePath:"/resumes",jobPath:"/jobs"}}}),_config2=_interopRequireDefault(_config),_viewsCreateView=require("../views/create-view"),_viewsCreateView2=_interopRequireDefault(_viewsCreateView),_viewsJobView=require("../views/job-view"),_viewsJobView2=_interopRequireDefault(_viewsJobView);require("jquery-ui");var AppController={currentView:null,createJob:function(){var e=new _viewsCreateView2["default"];this.renderView.call(self,e)},jobDetails:function(e){var r=this,t=function(){var e=_config2["default"].get("Client.restServer.address")+_config2["default"].get("Client.restServer.apiRoot")+_config2["default"].get("Client.restServer.resumePath"),r=new _dropzone2["default"]("#resume-dropzone",{url:e});r.on("sending",function(e,r,t){t.append("jobID",i.jobID)})},i=new _viewsJobView2["default"]({jobID:e});this.renderView.call(r,i).then(t)},renderView:function(e){var r=function(){this.currentView&&this.currentView.remove();return this.currentView=e,e.render().then(function(e){_jquery2["default"]("#main").html(e.el).fadeIn()})}.bind(this);return _jquery2["default"]("#main").fadeOut().promise().then(r)}};exports["default"]=AppController,module.exports=exports["default"];

},{"../views/create-view":7,"../views/job-view":8,"backbone":10,"dropzone":24,"jquery":26,"jquery-ui":25,"underscore":28}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_router=require("./router"),_router2=_interopRequireDefault(_router),_dropzone=require("dropzone"),_dropzone2=_interopRequireDefault(_dropzone);window.jQuery=require("jquery"),require("bootstrap");var router=new _router2["default"];_dropzone2["default"].autoDiscover=!1,_backbone2["default"].history.start({pushState:!1,root:"/"});

},{"./router":6,"backbone":10,"bootstrap":11,"dropzone":24,"jquery":26}],4:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),Job=_backbone2["default"].Model.extend({idAttribute:"id",urlRoot:"http://localhost:8080/api/jobs",defaults:{path:"",password:"",visibility:1}});exports["default"]=Job,module.exports=exports["default"];

},{"backbone":10}],5:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),Resume=_backbone2["default"].Model.extend({idAttribute:"id",urlRoot:"http://localhost:8080/api/resumes"});exports["default"]=Resume,module.exports=exports["default"];

},{"backbone":10}],6:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_get=function(e,t,r){for(var o=!0;o;){var n=e,i=t,u=r;o=!1,null===n&&(n=Function.prototype);var a=Object.getOwnPropertyDescriptor(n,i);if(void 0!==a){if("value"in a)return a.value;var l=a.get;return void 0===l?void 0:l.call(u)}var c=Object.getPrototypeOf(n);if(null===c)return void 0;e=c,t=i,r=u,o=!0,a=c=void 0}},_backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_componentsAppController=require("./components/app-controller"),_componentsAppController2=_interopRequireDefault(_componentsAppController),_viewsCreateView=require("./views/create-view"),_viewsCreateView2=_interopRequireDefault(_viewsCreateView),_viewsJobView=require("./views/job-view"),_viewsJobView2=_interopRequireDefault(_viewsJobView),routes={"":"createJob",":jobid":"jobDetails"},Router=function(e){function t(){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this,{routes:routes})}return _inherits(t,e),_createClass(t,[{key:"initialize",value:function(){var e;for(var t in this.routes)e=this.routes[t],this.route(t,e,_jquery2["default"].proxy(_componentsAppController2["default"][e],_componentsAppController2["default"]))}}]),t}(_backbone2["default"].Router);exports["default"]=Router,module.exports=exports["default"];

},{"./components/app-controller":2,"./views/create-view":7,"./views/job-view":8,"backbone":10,"jquery":26}],7:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),_modelsJob=require("../models/job"),_modelsJob2=_interopRequireDefault(_modelsJob),CreateView=_backbone2["default"].View.extend({model:_modelsJob2["default"],template:_underscore2["default"].template(_jquery2["default"]("#create-template").html()),render:function(){return this.$el.html(this.template()),Promise.resolve(this)},events:{"click #btnCreate":"addJob"},addJob:function(){var e=_jquery2["default"]("#txtTitle").val().trim(),t=_jquery2["default"]("#txtDesc").val().trim();if(_underscore2["default"].isEmpty(e)&&(_jquery2["default"]("#txtTitle").popover("show"),setTimeout(function(){_jquery2["default"]("#txtTitle").popover("hide")},1e3)),_underscore2["default"].isEmpty(t)&&(_jquery2["default"]("#txtDesc").popover("show"),setTimeout(function(){_jquery2["default"]("#txtDesc").popover("hide")},1e3)),!_underscore2["default"].isEmpty(e)&&!_underscore2["default"].isEmpty(t)){var r=new this.model({description:t,title:e});r.save(null,{success:function(e,t){_backbone2["default"].history.navigate(e.get("id"),!0)}})}}});exports["default"]=CreateView,module.exports=exports["default"];

},{"../models/job":4,"backbone":10,"jquery":26,"underscore":28}],8:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),_modelsJob=require("../models/job"),_modelsJob2=_interopRequireDefault(_modelsJob),_viewsResumeView=require("../views/resume-view"),_viewsResumeView2=_interopRequireDefault(_viewsResumeView),JobView=_backbone2["default"].View.extend({template:_underscore2["default"].template(_jquery2["default"]("#job-template").html()),initialize:function(e){this.jobID=e.jobID,this.model=new _modelsJob2["default"]({id:this.jobID})},render:function(){var e=this;return this.model.fetch().then(function(){e.$el.html(e.template({jobTitle:e.model.get("title"),jobDescription:e.model.get("description")}));var t=new _viewsResumeView2["default"]({jobID:e.jobID});return t.render().then(function(t){return e.$el.append(t.el),e})})}});exports["default"]=JobView,module.exports=exports["default"];

},{"../models/job":4,"../views/resume-view":9,"backbone":10,"jquery":26,"underscore":28}],9:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0});var _backbone=require("backbone"),_backbone2=_interopRequireDefault(_backbone),_jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_underscore=require("underscore"),_underscore2=_interopRequireDefault(_underscore),_config=function(e){var t={},r=function(e,t){t=t.replace(/\[(\w+)\]/g,".$1"),t=t.replace(/^\./,"");for(var r=t.split("."),n=0,i=r.length;i>n;++n){var o=r[n];if(!(o in e))return;e=e[o]}return e};return t.get=function(t){return r(e,t)},t}({Client:{testProperty:"Default",restServer:{address:"http://188.166.232.209:8080",apiRoot:"/api",resumePath:"/resumes",jobPath:"/jobs"}}}),_config2=_interopRequireDefault(_config),_dropzone=require("dropzone"),_dropzone2=_interopRequireDefault(_dropzone),_spinJs=require("spin.js"),_spinJs2=_interopRequireDefault(_spinJs),_collectionsResumes=require("../collections/resumes"),_collectionsResumes2=_interopRequireDefault(_collectionsResumes),ResumeView=_backbone2["default"].View.extend({template:_underscore2["default"].template(_jquery2["default"]("#resume-template").html()),dataTemplate:_underscore2["default"].template(_jquery2["default"]("#data-template").html()),initialize:function(e){this.collection=new _collectionsResumes2["default"],this.jobID=e.jobID,this.scoreDescending=!0,this.limit=10,this.timer=setInterval(function(){this.collection.fetch({data:{id:this.jobID}})}.bind(this),5e3),this.listenTo(this.collection,"add",this.refreshTable)},events:{"click #scoreToggle":"toggleSort","keyup #resumeCount":"handleFilterChange"},close:function(){clearInterval(this.timer)},render:function(){var e=this,t=function(t){var r=0===e.collection.length?{isEmpty:!0}:{isEmpty:!1,dataTable:t};return e.$el.html(e.template(r)),e};return this.renderCollection().then(t)},renderCollection:function(){var e=this,t=function(){if(0===e.collection.length)return null;var t={};return t.resumes=e.collection.first(parseInt(e.limit)),t.resumes=_underscore2["default"].map(t.resumes,function(r,n){return r=r.toJSON(),r.fileName=r.resumePath.split("/").pop(),r.download=_config2["default"].get("Client.restServer.address")+_config2["default"].get("Client.restServer.apiRoot")+_config2["default"].get("Client.restServer.resumePath")+"/"+r.id,r.rank=e.scoreDescending?n+1:t.resumes.length-n,r}),t.resumes=_underscore2["default"].sortBy(t.resumes,function(t){return e.scoreDescending?-t.score:t.score}),e.dataTemplate(t)};return this.collection.fetch({data:{id:this.jobID}}).then(t)},renderTable:function(e){return Promise.resolve(_jquery2["default"]("#data-table").html(e))},refreshTable:function(){return this.renderCollection().then(this.renderTable)},toggleSort:function(){this.scoreDescending=!this.scoreDescending;var e=this.scoreDescending?"down":"up",t=this.scoreDescending?"up":"down",r=function(r){var n=_jquery2["default"]("#sortArrow").attr("src");n=n.replace(new RegExp(t,"g"),e),_jquery2["default"]("#sortArrow").attr("src",n)};this.renderCollection().then(this.renderTable).then(r)},handleFilterChange:function(){var e=_jquery2["default"]("#resumeCount").val().trim();if(_underscore2["default"].isEmpty(e))this.limit=10;else{if(_underscore2["default"].isFinite(e)&&e>0)return this.limit=e,this.refreshTable();_jquery2["default"]("#resumeCount").popover("show"),setTimeout(function(){_jquery2["default"]("#resumeCount").popover("hide")},1e3)}}});exports["default"]=ResumeView,module.exports=exports["default"];

},{"../collections/resumes":1,"backbone":10,"dropzone":24,"jquery":26,"spin.js":27,"underscore":28}],10:[function(require,module,exports){
(function (global){
...
},{"jquery":26,"underscore":28}],11:[function(require,module,exports){
